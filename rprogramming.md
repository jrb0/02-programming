...
Functions have three main parts: - Name: how to call the function (e.g.,
`count` or `summary`).  
...
which serves here as an explicit placeholder for the input from a prior
operation. You can simplify to `mydata %>% count(var1)`.
